 infoq上[深入浅出Docker（一）：Docker核心技术预览](http://www.infoq.com/cn/articles/docker-core-technology-preview)一文中非常详细地描述了AUFS构建成镜像、容器的完整过程，此处只做引用。  
...
![基础镜像](./images/bootfs_rootfs.png "基础的Linux操作系统")
...
![不同的Linux发行版](./images/linux_distribution.png "不同的Linux发行版")
...
![添加不同应用的镜像](./images/image_with_apps.png "添加应用后的镜像")
...
![基于image的容器](./images/container_on_image.png "基于image的容器")
...
![image之间的继承关系](./images/image_and_parent_image.png "image之间的继承关系")。
